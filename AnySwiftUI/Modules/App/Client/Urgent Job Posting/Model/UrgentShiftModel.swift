...
struct Api_FetchUrgentShift : Codable {
    let result : [Res_FetchUrgentShift]?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([Res_FetchUrgentShift].self, forKey: .result)
...
struct Res_FetchUrgentShift : Codable, Identifiable {
    ...
    let shift_accepted_status : String?
    let format_date : String?
    let shift_multi_work_time : [Shift_multi_work_time]?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case shift_accepted_status = "shift_accepted_status"
        case format_date = "format_date"
        case shift_multi_work_time = "shift_multi_work_time"
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        shift_accepted_status = try values.decodeIfPresent(String.self, forKey: .shift_accepted_status)
        format_date = try values.decodeIfPresent(String.self, forKey: .format_date)
        shift_multi_work_time = try values.decodeIfPresent([Shift_multi_work_time].self, forKey: .shift_multi_work_time)
    }
}

struct Shift_multi_work_time : Codable {
    let id : String?
    let shift_id : String?
    let user_id : String?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case user_id = "user_id"
        case work_start_time = "work_start_time"
        case work_end_time = "work_end_time"
        case rate = "rate"
        case job_type = "job_type"
        case job_type_id = "job_type_id"
        case total_time = "total_time"
    ...
    init(from decoder: Decoder) throws {
        ...
        user_id = try values.decodeIfPresent(String.self, forKey: .user_id)
        work_start_time = try values.decodeIfPresent(String.self, forKey: .work_start_time)
        work_end_time = try values.decodeIfPresent(String.self, forKey: .work_end_time)
