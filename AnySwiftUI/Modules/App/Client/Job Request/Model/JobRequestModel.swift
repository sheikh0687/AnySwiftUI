...
struct Api_WorkerRequest : Codable {
    
    let pending_shift_count : Int?
    let result : [Res_WorkerRequest]?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([Res_WorkerRequest].self, forKey: .result)
...
struct Res_WorkerRequest : Codable, Identifiable, Hashable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case shift_estimate_amount = "shift_estimate_amount"
    ...
    init(from decoder: Decoder) throws {
        ...
        shift_estimate_amount = try values.decodeIfPresent(Int.self, forKey: .shift_estimate_amount)
