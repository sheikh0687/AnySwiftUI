...
struct Api_ManpowerShift : Codable {
    let pending_shift_count : Int?
    let today_pending_shift_count : Int?
    let result : Res_ManpowerShift?
    let message : String?
    let status : String?

    enum CodingKeys: String, CodingKey {
        case pending_shift_count = "pending_shift_count"
        case today_pending_shift_count = "today_pending_shift_count"
        case result = "result"
    ...
    init(from decoder: Decoder) throws {
        ...
        today_pending_shift_count = try values.decodeIfPresent(Int.self, forKey: .today_pending_shift_count)
        result = try values.decodeIfPresent(Res_ManpowerShift.self, forKey: .result)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
}

struct Res_ManpowerShift : Codable {
    let shift_name : String?
    let shift_description : String?
    let total_shift_worker_count : Int?
    let total_worker_booked_count : Int?
    let worker_details : [Worker_details]?
    
    enum CodingKeys: String, CodingKey {
        
        case shift_name = "shift_name"
        case shift_description = "shift_description"
        case total_shift_worker_count = "total_shift_worker_count"
        case total_worker_booked_count = "total_worker_booked_count"
    ...
    init(from decoder: Decoder) throws {
        ...
        shift_description = try values.decodeIfPresent(String.self, forKey: .shift_description)
        total_shift_worker_count = try values.decodeIfPresent(Int.self, forKey: .total_shift_worker_count)
        total_worker_booked_count = try values.decodeIfPresent(Int.self, forKey: .total_worker_booked_count)
...
struct Worker_details : Codable {
    ...
    let shift_booking_details : Shift_booking_details?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case shift_booking_details = "shift_booking_details"
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        shift_booking_details = try values.decodeIfPresent(Shift_booking_details.self, forKey: .shift_booking_details)
    }
}

struct Shift_booking_details : Codable {
    let id : String?
    let card_id : String?
    let customer_id : String?
    let shift_id : String?
