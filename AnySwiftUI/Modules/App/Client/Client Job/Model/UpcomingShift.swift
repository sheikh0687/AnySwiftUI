...
struct Api_UpcomingShifts : Codable {
    let result : [Res_UpcomingShifts]?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([Res_UpcomingShifts].self, forKey: .result)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
}

struct Res_UpcomingShifts : Codable {
    let date : String?
    let selected_day_my_booking_status : String?
    let shift_count : Int?
    let shift_details : [UpcomingShift_details]?
    ...
    init(from decoder: Decoder) throws {
        ...
        shift_details = try values.decodeIfPresent([UpcomingShift_details].self, forKey: .shift_details)
    }

}

struct UpcomingShift_details : Codable {
    let id : String?
    let user_id : String?
    ...
    let booked_worker_count : Int?
    let remain_worker_count : Int?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case booked_worker_count = "booked_worker_count"
        case remain_worker_count = "remain_worker_count"
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        booked_worker_count = try values.decodeIfPresent(Int.self, forKey: .booked_worker_count)
        remain_worker_count = try values.decodeIfPresent(Int.self, forKey: .remain_worker_count)
    }
