...
struct Api_ShiftDetails : Codable {
    let result : Res_ShiftDetails?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent(Res_ShiftDetails.self, forKey: .result)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
}

struct Res_ShiftDetails : Codable {
    let id : String?
    let user_id : String?
    ...
    let shift_brodcast_week_days : [Shift_brodcast_week_days]?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case shift_brodcast_week_days = "shift_brodcast_week_days"
    ...
    init(from decoder: Decoder) throws {
        ...
        shift_brodcast_week_days = try values.decodeIfPresent([Shift_brodcast_week_days].self, forKey: .shift_brodcast_week_days)
...
struct Shift_brodcast_week_days : Codable {
    let id : String?
    let shift_id : String?
    let user_id : String?
    let day_name : String?
