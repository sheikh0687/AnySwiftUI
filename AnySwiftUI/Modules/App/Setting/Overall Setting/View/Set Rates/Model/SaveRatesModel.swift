...
struct Api_SaveRates : Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([Res_SaveRates].self, forKey: .result)
...
struct WeeklyRateItem: Identifiable {
    let id: String
    let dayName: String
    var rate: Int          // mutable Int for easy stepper logic
